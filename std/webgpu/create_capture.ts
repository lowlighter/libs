import type { CreateCapture as _interface_CreateCapture } from "jsr:@std/webgpu@0.224.7/create-capture"
/**
...
import { createCapture as _function_createCapture } from "jsr:@std/webgpu@0.224.7/create-capture"
/**
