 ...
 * @module
 */
import { BufferFullError as _class_BufferFullError } from "jsr:@std/io@0.224.4"
/**
...
import { PartialReadError as _class_PartialReadError } from "jsr:@std/io@0.224.4"
/**
 * @deprecated This will be removed in 1.0.0. Use the {@link https://developer.mozilla.org/en-US/docs/Web/API/Streams_API | Web Streams API} instead.
 */
...
import type { ReadLineResult as _interface_ReadLineResult } from "jsr:@std/io@0.224.4"
/**
...
import { BufReader as _class_BufReader } from "jsr:@std/io@0.224.4"
/**
 * @deprecated This will be removed in 1.0.0. Use the {@link https://developer.mozilla.org/en-US/docs/Web/API/Streams_API | Web Streams API} instead.
 */
...
import { BufWriter as _class_BufWriter } from "jsr:@std/io@0.224.4"
/**
...
import { BufWriterSync as _class_BufWriterSync } from "jsr:@std/io@0.224.4"
/**
...
import { Buffer as _class_Buffer } from "jsr:@std/io@0.224.4"
/**
...
import { copy as _function_copy } from "jsr:@std/io@0.224.4"
/**
...
import { copyN as _function_copyN } from "jsr:@std/io@0.224.4"
/**
...
import type { Reader as _interface_Reader } from "jsr:@std/io@0.224.4"
/**
...
import type { ReaderSync as _interface_ReaderSync } from "jsr:@std/io@0.224.4"
/**
...
import { iterateReader as _function_iterateReader } from "jsr:@std/io@0.224.4"
/**
...
import { iterateReaderSync as _function_iterateReaderSync } from "jsr:@std/io@0.224.4"
/**
...
import { LimitedReader as _class_LimitedReader } from "jsr:@std/io@0.224.4"
/**
 * @deprecated This will be removed in 1.0.0. Use the {@link https://developer.mozilla.org/en-US/docs/Web/API/Streams_API | Web Streams API} instead.
 */
...
import { MultiReader as _class_MultiReader } from "jsr:@std/io@0.224.4"
/**
...
import { readAll as _function_readAll } from "jsr:@std/io@0.224.4"
/**
...
import { readAllSync as _function_readAllSync } from "jsr:@std/io@0.224.4"
/**
...
import { readDelim as _function_readDelim } from "jsr:@std/io@0.224.4"
/**
...
import { readInt as _function_readInt } from "jsr:@std/io@0.224.4"
/**
...
import { readLines as _function_readLines } from "jsr:@std/io@0.224.4"
/**
...
import { readLong as _function_readLong } from "jsr:@std/io@0.224.4"
/**
...
import type { ByteRange as _interface_ByteRange } from "jsr:@std/io@0.224.4"
/**
 * @deprecated This will be removed in 1.0.0. Use the {@link https://developer.mozilla.org/en-US/docs/Web/API/Streams_API | Web Streams API} instead.
 */
...
import { readRange as _function_readRange } from "jsr:@std/io@0.224.4"
/**
...
import { readRangeSync as _function_readRangeSync } from "jsr:@std/io@0.224.4"
/**
...
import { readShort as _function_readShort } from "jsr:@std/io@0.224.4"
/**
...
import { readStringDelim as _function_readStringDelim } from "jsr:@std/io@0.224.4"
/**
...
import { readerFromStreamReader as _function_readerFromStreamReader } from "jsr:@std/io@0.224.4"
/**
...
import { sliceLongToBytes as _function_sliceLongToBytes } from "jsr:@std/io@0.224.4"
/**
...
import { StringReader as _class_StringReader } from "jsr:@std/io@0.224.4"
/**
...
import { StringWriter as _class_StringWriter } from "jsr:@std/io@0.224.4"
/**
...
import type { ToReadableStreamOptions as _interface_ToReadableStreamOptions } from "jsr:@std/io@0.224.4"
/**
...
import { toReadableStream as _function_toReadableStream } from "jsr:@std/io@0.224.4"
/**
...
import type { toWritableStreamOptions as _interface_toWritableStreamOptions } from "jsr:@std/io@0.224.4"
/**
...
import { toWritableStream as _function_toWritableStream } from "jsr:@std/io@0.224.4"
/**
...
import type { Writer as _interface_Writer } from "jsr:@std/io@0.224.4"
/**
...
import type { WriterSync as _interface_WriterSync } from "jsr:@std/io@0.224.4"
/**
...
import type { Closer as _interface_Closer } from "jsr:@std/io@0.224.4"
/**
...
import { writeAll as _function_writeAll } from "jsr:@std/io@0.224.4"
/**
...
import { writeAllSync as _function_writeAllSync } from "jsr:@std/io@0.224.4"
/**
