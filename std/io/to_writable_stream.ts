import type { toWritableStreamOptions as _interface_toWritableStreamOptions } from "jsr:@std/io@0.224.5/to-writable-stream"
/**
...
import { toWritableStream as _function_toWritableStream } from "jsr:@std/io@0.224.5/to-writable-stream"
/**
