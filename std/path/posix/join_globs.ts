import type { GlobOptions as _interface_GlobOptions } from "jsr:@std/path@1.0.6/posix/join-globs"
/**
...
import { joinGlobs as _function_joinGlobs } from "jsr:@std/path@1.0.6/posix/join-globs"
/**
