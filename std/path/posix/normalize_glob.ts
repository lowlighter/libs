import type { GlobOptions as _interface_GlobOptions } from "jsr:@std/path@1.0.6/posix/normalize-glob"
/**
...
import { normalizeGlob as _function_normalizeGlob } from "jsr:@std/path@1.0.6/posix/normalize-glob"
/**
