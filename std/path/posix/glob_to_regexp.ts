import type { GlobOptions as _interface_GlobOptions } from "jsr:@std/path@1.0.1/posix/glob-to-regexp"
/**
...
import { globToRegExp as _function_globToRegExp } from "jsr:@std/path@1.0.1/posix/glob-to-regexp"
/**
