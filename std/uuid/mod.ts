import { v1 as _variable_v1 } from "jsr:@std/uuid@1.0.0"
/**
 ...
 * ```
 */
const v1 = _variable_v1
export { v1 }

import { v3 as _variable_v3 } from "jsr:@std/uuid@1.0.0"
/**
 * Generator and validator for
 ...
 * ```
 */
const v3 = _variable_v3
export { v3 }

import { v4 as _variable_v4 } from "jsr:@std/uuid@1.0.0"
/**
 * Validator for
 ...
 * ```
 */
const v4 = _variable_v4
export { v4 }

import { v5 as _variable_v5 } from "jsr:@std/uuid@1.0.0"
/**
 * Generator and validator for
 ...
 * ```
 */
const v5 = _variable_v5
export { v5 }

import { isNil as _function_isNil } from "jsr:@std/uuid@1.0.0"
/**
...
import { validate as _function_validate } from "jsr:@std/uuid@1.0.0"
/**
...
import { version as _function_version } from "jsr:@std/uuid@1.0.0"
/**
...
import { NAMESPACE_DNS as _variable_NAMESPACE_DNS } from "jsr:@std/uuid@1.0.0"
/**
 ...
 * ```
 */
const NAMESPACE_DNS = _variable_NAMESPACE_DNS
export { NAMESPACE_DNS }

import { NAMESPACE_URL as _variable_NAMESPACE_URL } from "jsr:@std/uuid@1.0.0"
/**
 ...
 * ```
 */
const NAMESPACE_URL = _variable_NAMESPACE_URL
export { NAMESPACE_URL }

import { NAMESPACE_OID as _variable_NAMESPACE_OID } from "jsr:@std/uuid@1.0.0"
/**
 ...
 * ```
 */
const NAMESPACE_OID = _variable_NAMESPACE_OID
export { NAMESPACE_OID }

import { NAMESPACE_X500 as _variable_NAMESPACE_X500 } from "jsr:@std/uuid@1.0.0"
/**
 ...
 * ```
 */
const NAMESPACE_X500 = _variable_NAMESPACE_X500
export { NAMESPACE_X500 }

import { NIL_UUID as _variable_NIL_UUID } from "jsr:@std/uuid@1.0.0"
/**
 * The nil UUID is special form of UUID that is specified to have all 128 bits
 * set to zero.
 */
const NIL_UUID = _variable_NIL_UUID
export { NIL_UUID }
