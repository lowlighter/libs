import { METHOD as _variable_METHOD } from "jsr:@std/http@1.0.8/unstable-method"
/**
...
import type { Method as _typeAlias_Method } from "jsr:@std/http@1.0.8/unstable-method"
/**
 * A HTTP Method
 *
 * @experimental
