import { METHOD as _variable_METHOD } from "jsr:@std/http@1.0.7/unstable-method"
/**
...
import type { Method as _typeAlias_Method } from "jsr:@std/http@1.0.7/unstable-method"
/**
 * A HTTP Method
 *
 * @experimental
