 ...
 * @module
 */
import type { Cookie as _interface_Cookie } from "jsr:@std/http@1.0.5"
/**
...
import { getCookies as _function_getCookies } from "jsr:@std/http@1.0.5"
/**
...
import { setCookie as _function_setCookie } from "jsr:@std/http@1.0.5"
/**
...
import { deleteCookie as _function_deleteCookie } from "jsr:@std/http@1.0.5"
/**
...
import { getSetCookies as _function_getSetCookies } from "jsr:@std/http@1.0.5"
/**
...
import type { FileInfo as _interface_FileInfo } from "jsr:@std/http@1.0.5"
/**
...
import type { ETagOptions as _interface_ETagOptions } from "jsr:@std/http@1.0.5"
/**
...
import { eTag as _function_eTag } from "jsr:@std/http@1.0.5"
/** UNDOCUMENTED */
const eTag = _function_eTag as typeof _function_eTag
export { eTag }

import { ifMatch as _function_ifMatch } from "jsr:@std/http@1.0.5"
/**
...
import { ifNoneMatch as _function_ifNoneMatch } from "jsr:@std/http@1.0.5"
/**
...
import { STATUS_CODE as _variable_STATUS_CODE } from "jsr:@std/http@1.0.5"
/**
...
import type { StatusCode as _typeAlias_StatusCode } from "jsr:@std/http@1.0.5"
/**
 * An HTTP status code.
 */
...
import { STATUS_TEXT as _variable_STATUS_TEXT } from "jsr:@std/http@1.0.5"
/**
...
import type { StatusText as _typeAlias_StatusText } from "jsr:@std/http@1.0.5"
/**
 * An HTTP status text.
 */
...
import type { InformationalStatus as _typeAlias_InformationalStatus } from "jsr:@std/http@1.0.5"
/**
...
import type { SuccessfulStatus as _typeAlias_SuccessfulStatus } from "jsr:@std/http@1.0.5"
/**
...
import type { RedirectStatus as _typeAlias_RedirectStatus } from "jsr:@std/http@1.0.5"
/**
...
import type { ClientErrorStatus as _typeAlias_ClientErrorStatus } from "jsr:@std/http@1.0.5"
/**
...
import type { ServerErrorStatus as _typeAlias_ServerErrorStatus } from "jsr:@std/http@1.0.5"
/**
...
import type { ErrorStatus as _typeAlias_ErrorStatus } from "jsr:@std/http@1.0.5"
/**
...
import { isStatus as _function_isStatus } from "jsr:@std/http@1.0.5"
/**
...
import { isInformationalStatus as _function_isInformationalStatus } from "jsr:@std/http@1.0.5"
/**
...
import { isSuccessfulStatus as _function_isSuccessfulStatus } from "jsr:@std/http@1.0.5"
/**
...
import { isRedirectStatus as _function_isRedirectStatus } from "jsr:@std/http@1.0.5"
/**
...
import { isClientErrorStatus as _function_isClientErrorStatus } from "jsr:@std/http@1.0.5"
/**
...
import { isServerErrorStatus as _function_isServerErrorStatus } from "jsr:@std/http@1.0.5"
/**
...
import { isErrorStatus as _function_isErrorStatus } from "jsr:@std/http@1.0.5"
/**
...
import { accepts as _function_accepts } from "jsr:@std/http@1.0.5"
/** UNDOCUMENTED */
const accepts = _function_accepts as typeof _function_accepts
export { accepts }

import { acceptsEncodings as _function_acceptsEncodings } from "jsr:@std/http@1.0.5"
/** UNDOCUMENTED */
const acceptsEncodings = _function_acceptsEncodings as typeof _function_acceptsEncodings
export { acceptsEncodings }

import { acceptsLanguages as _function_acceptsLanguages } from "jsr:@std/http@1.0.5"
/** UNDOCUMENTED */
const acceptsLanguages = _function_acceptsLanguages as typeof _function_acceptsLanguages
export { acceptsLanguages }

import { signCookie as _function_signCookie } from "jsr:@std/http@1.0.5"
/**
...
import { verifySignedCookie as _function_verifySignedCookie } from "jsr:@std/http@1.0.5"
/**
...
import { parseSignedCookie as _function_parseSignedCookie } from "jsr:@std/http@1.0.5"
/**
...
import type { ServerSentEventMessage as _interface_ServerSentEventMessage } from "jsr:@std/http@1.0.5"
/**
...
import { ServerSentEventStream as _class_ServerSentEventStream } from "jsr:@std/http@1.0.5"
/**
...
import type { Browser as _interface_Browser } from "jsr:@std/http@1.0.5"
/**
...
import type { Device as _interface_Device } from "jsr:@std/http@1.0.5"
/**
...
import type { Engine as _interface_Engine } from "jsr:@std/http@1.0.5"
/**
...
import type { Os as _interface_Os } from "jsr:@std/http@1.0.5"
/**
...
import type { Cpu as _interface_Cpu } from "jsr:@std/http@1.0.5"
/**
...
import { UserAgent as _class_UserAgent } from "jsr:@std/http@1.0.5"
/**
...
import type { ServeFileOptions as _interface_ServeFileOptions } from "jsr:@std/http@1.0.5"
/**
...
import { serveFile as _function_serveFile } from "jsr:@std/http@1.0.5"
/**
...
import type { ServeDirOptions as _interface_ServeDirOptions } from "jsr:@std/http@1.0.5"
/**
...
import { serveDir as _function_serveDir } from "jsr:@std/http@1.0.5"
/**
...
import type { Handler as _typeAlias_Handler } from "jsr:@std/http@1.0.5"
/**
...
import type { Route as _interface_Route } from "jsr:@std/http@1.0.5"
/**
...
import { route as _function_route } from "jsr:@std/http@1.0.5"
/**
...
import { HEADER as _variable_HEADER } from "jsr:@std/http@1.0.5"
/**
...
import type { Header as _typeAlias_Header } from "jsr:@std/http@1.0.5"
/**
 * A HTTP Header
 *
 * @experimental
...
import { METHOD as _variable_METHOD } from "jsr:@std/http@1.0.5"
/**
...
import type { Method as _typeAlias_Method } from "jsr:@std/http@1.0.5"
/**
 * A HTTP Method
 *
 * @experimental
