import { STATUS_CODE as _variable_STATUS_CODE } from "jsr:@std/http@1.0.6/status"
/**
...
import type { StatusCode as _typeAlias_StatusCode } from "jsr:@std/http@1.0.6/status"
/**
 * An HTTP status code.
 */
...
import { STATUS_TEXT as _variable_STATUS_TEXT } from "jsr:@std/http@1.0.6/status"
/**
...
import type { StatusText as _typeAlias_StatusText } from "jsr:@std/http@1.0.6/status"
/**
 * An HTTP status text.
 */
...
import type { InformationalStatus as _typeAlias_InformationalStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import type { SuccessfulStatus as _typeAlias_SuccessfulStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import type { RedirectStatus as _typeAlias_RedirectStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import type { ClientErrorStatus as _typeAlias_ClientErrorStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import type { ServerErrorStatus as _typeAlias_ServerErrorStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import type { ErrorStatus as _typeAlias_ErrorStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import { isStatus as _function_isStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import { isInformationalStatus as _function_isInformationalStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import { isSuccessfulStatus as _function_isSuccessfulStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import { isRedirectStatus as _function_isRedirectStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import { isClientErrorStatus as _function_isClientErrorStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import { isServerErrorStatus as _function_isServerErrorStatus } from "jsr:@std/http@1.0.6/status"
/**
...
import { isErrorStatus as _function_isErrorStatus } from "jsr:@std/http@1.0.6/status"
/**
