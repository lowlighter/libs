import type { ServerSentEventMessage as _interface_ServerSentEventMessage } from "jsr:@std/http@1.0.3/server-sent-event-stream"
/**
...
import { ServerSentEventStream as _class_ServerSentEventStream } from "jsr:@std/http@1.0.3/server-sent-event-stream"
/**
