import type { Browser as _interface_Browser } from "jsr:@std/http@1.0.4/user-agent"
/**
...
import type { Device as _interface_Device } from "jsr:@std/http@1.0.4/user-agent"
/**
...
import type { Engine as _interface_Engine } from "jsr:@std/http@1.0.4/user-agent"
/**
...
import type { Os as _interface_Os } from "jsr:@std/http@1.0.4/user-agent"
/**
...
import type { Cpu as _interface_Cpu } from "jsr:@std/http@1.0.4/user-agent"
/**
...
import { UserAgent as _class_UserAgent } from "jsr:@std/http@1.0.4/user-agent"
/**
