import { assertType as _function_assertType } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { AssertTrue as _typeAlias_AssertTrue } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { AssertFalse as _typeAlias_AssertFalse } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { Assert as _typeAlias_Assert } from "jsr:@std/testing@1.0.2/types"
/**
 * Asserts at compile time that the provided type argument's type resolves to the expected boolean literal type.
 *
 * @example Usage
...
import type { Has as _typeAlias_Has } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { NotHas as _typeAlias_NotHas } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { IsNullable as _typeAlias_IsNullable } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { IsExact as _typeAlias_IsExact } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { DeepPrepareIsExact as _typeAlias_DeepPrepareIsExact } from "jsr:@std/testing@1.0.2/types"
/**
 * @internal
 */
...
import type { DeepPrepareIsExactProp as _typeAlias_DeepPrepareIsExactProp } from "jsr:@std/testing@1.0.2/types"
/**
 * @internal
 */
...
import type { IsAny as _typeAlias_IsAny } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { IsNever as _typeAlias_IsNever } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { IsUnknown as _typeAlias_IsUnknown } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { ParametersAndReturnTypeMatches as _typeAlias_ParametersAndReturnTypeMatches } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { TupleMatches as _typeAlias_TupleMatches } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { Matches as _typeAlias_Matches } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { AnyToBrand as _typeAlias_AnyToBrand } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { AnyBrand as _typeAlias_AnyBrand } from "jsr:@std/testing@1.0.2/types"
/**
...
import type { FlatType as _typeAlias_FlatType } from "jsr:@std/testing@1.0.2/types"
/**
