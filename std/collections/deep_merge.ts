import { deepMerge as _function_deepMerge } from "jsr:@std/collections@1.0.6/deep-merge"
/** UNDOCUMENTED */
const deepMerge = _function_deepMerge as typeof _function_deepMerge
export { deepMerge }

import type { MergingStrategy as _typeAlias_MergingStrategy } from "jsr:@std/collections@1.0.6/deep-merge"
/**
 * Merging strategy
 */
...
import type { DeepMergeOptions as _typeAlias_DeepMergeOptions } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { ExpandRecursively as _typeAlias_ExpandRecursively } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { PartialByType as _typeAlias_PartialByType } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { SetValueType as _typeAlias_SetValueType } from "jsr:@std/collections@1.0.6/deep-merge"
/**
 * Get set values type
 */
...
import type { MergeAllSets as _typeAlias_MergeAllSets } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { ArrayValueType as _typeAlias_ArrayValueType } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { MergeAllArrays as _typeAlias_MergeAllArrays } from "jsr:@std/collections@1.0.6/deep-merge"
/**
 * Merge all sets types definitions from keys present in both objects
 */
...
import type { MapKeyType as _typeAlias_MapKeyType } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { MapValueType as _typeAlias_MapValueType } from "jsr:@std/collections@1.0.6/deep-merge"
/**
 * Get map values types
 */
...
import type { MergeAllMaps as _typeAlias_MergeAllMaps } from "jsr:@std/collections@1.0.6/deep-merge"
/**
 * Merge all sets types definitions from keys present in both objects
 */
...
import type { MergeAllRecords as _typeAlias_MergeAllRecords } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { OmitComplexes as _typeAlias_OmitComplexes } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { ObjectXorKeys as _typeAlias_ObjectXorKeys } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { MergeRightOmitComplexes as _typeAlias_MergeRightOmitComplexes } from "jsr:@std/collections@1.0.6/deep-merge"
/**
...
import type { Merge as _typeAlias_Merge } from "jsr:@std/collections@1.0.6/deep-merge"
/**
 * Merge two objects
 */
type Merge<
...
import type { DeepMerge as _typeAlias_DeepMerge } from "jsr:@std/collections@1.0.6/deep-merge"
/**
