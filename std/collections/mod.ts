 ...
 * @module
 */
import { aggregateGroups as _function_aggregateGroups } from "jsr:@std/collections@1.0.6"
/**
...
import { associateBy as _function_associateBy } from "jsr:@std/collections@1.0.6"
/**
...
import { associateWith as _function_associateWith } from "jsr:@std/collections@1.0.6"
/**
...
import { chunk as _function_chunk } from "jsr:@std/collections@1.0.6"
/**
...
import { deepMerge as _function_deepMerge } from "jsr:@std/collections@1.0.6"
/** UNDOCUMENTED */
const deepMerge = _function_deepMerge as typeof _function_deepMerge
export { deepMerge }

import type { MergingStrategy as _typeAlias_MergingStrategy } from "jsr:@std/collections@1.0.6"
/**
 * Merging strategy
 */
...
import type { DeepMergeOptions as _typeAlias_DeepMergeOptions } from "jsr:@std/collections@1.0.6"
/**
...
import type { ExpandRecursively as _typeAlias_ExpandRecursively } from "jsr:@std/collections@1.0.6"
/**
...
import type { PartialByType as _typeAlias_PartialByType } from "jsr:@std/collections@1.0.6"
/**
...
import type { SetValueType as _typeAlias_SetValueType } from "jsr:@std/collections@1.0.6"
/**
 * Get set values type
 */
...
import type { MergeAllSets as _typeAlias_MergeAllSets } from "jsr:@std/collections@1.0.6"
/**
...
import type { ArrayValueType as _typeAlias_ArrayValueType } from "jsr:@std/collections@1.0.6"
/**
...
import type { MergeAllArrays as _typeAlias_MergeAllArrays } from "jsr:@std/collections@1.0.6"
/**
 * Merge all sets types definitions from keys present in both objects
 */
...
import type { MapKeyType as _typeAlias_MapKeyType } from "jsr:@std/collections@1.0.6"
/**
...
import type { MapValueType as _typeAlias_MapValueType } from "jsr:@std/collections@1.0.6"
/**
 * Get map values types
 */
...
import type { MergeAllMaps as _typeAlias_MergeAllMaps } from "jsr:@std/collections@1.0.6"
/**
 * Merge all sets types definitions from keys present in both objects
 */
...
import type { MergeAllRecords as _typeAlias_MergeAllRecords } from "jsr:@std/collections@1.0.6"
/**
...
import type { OmitComplexes as _typeAlias_OmitComplexes } from "jsr:@std/collections@1.0.6"
/**
...
import type { ObjectXorKeys as _typeAlias_ObjectXorKeys } from "jsr:@std/collections@1.0.6"
/**
...
import type { MergeRightOmitComplexes as _typeAlias_MergeRightOmitComplexes } from "jsr:@std/collections@1.0.6"
/**
...
import type { Merge as _typeAlias_Merge } from "jsr:@std/collections@1.0.6"
/**
 * Merge two objects
 */
type Merge<
...
import type { DeepMerge as _typeAlias_DeepMerge } from "jsr:@std/collections@1.0.6"
/**
...
import { distinct as _function_distinct } from "jsr:@std/collections@1.0.6"
/**
...
import { distinctBy as _function_distinctBy } from "jsr:@std/collections@1.0.6"
/**
...
import { dropLastWhile as _function_dropLastWhile } from "jsr:@std/collections@1.0.6"
/**
...
import { dropWhile as _function_dropWhile } from "jsr:@std/collections@1.0.6"
/**
 * Returns a new array that drops all elements in the given collection until the
...
import { filterEntries as _function_filterEntries } from "jsr:@std/collections@1.0.6"
/**
...
import { filterKeys as _function_filterKeys } from "jsr:@std/collections@1.0.6"
/**
...
import { filterValues as _function_filterValues } from "jsr:@std/collections@1.0.6"
/**
 * Returns a new record with all entries of the given record except the ones
...
import { findSingle as _function_findSingle } from "jsr:@std/collections@1.0.6"
/**
...
import { firstNotNullishOf as _function_firstNotNullishOf } from "jsr:@std/collections@1.0.6"
/**
...
import { includesValue as _function_includesValue } from "jsr:@std/collections@1.0.6"
/**
...
import { intersect as _function_intersect } from "jsr:@std/collections@1.0.6"
/**
...
import type { InvertByResult as _typeAlias_InvertByResult } from "jsr:@std/collections@1.0.6"
/**
...
import { invertBy as _function_invertBy } from "jsr:@std/collections@1.0.6"
/**
...
import type { InvertResult as _typeAlias_InvertResult } from "jsr:@std/collections@1.0.6"
/**
...
import { invert as _function_invert } from "jsr:@std/collections@1.0.6"
/**
 * Composes a new record with all keys and values inverted.
 *
...
import type { JoinToStringOptions as _typeAlias_JoinToStringOptions } from "jsr:@std/collections@1.0.6"
/**
...
import { joinToString as _function_joinToString } from "jsr:@std/collections@1.0.6"
/**
...
import { mapEntries as _function_mapEntries } from "jsr:@std/collections@1.0.6"
/**
...
import { mapKeys as _function_mapKeys } from "jsr:@std/collections@1.0.6"
/**
...
import { mapNotNullish as _function_mapNotNullish } from "jsr:@std/collections@1.0.6"
/**
...
import { mapValues as _function_mapValues } from "jsr:@std/collections@1.0.6"
/** UNDOCUMENTED */
const mapValues = _function_mapValues as typeof _function_mapValues
export { mapValues }

import { maxBy as _function_maxBy } from "jsr:@std/collections@1.0.6"
/** UNDOCUMENTED */
const maxBy = _function_maxBy as typeof _function_maxBy
export { maxBy }

import { maxOf as _function_maxOf } from "jsr:@std/collections@1.0.6"
/** UNDOCUMENTED */
const maxOf = _function_maxOf as typeof _function_maxOf
export { maxOf }

import { maxWith as _function_maxWith } from "jsr:@std/collections@1.0.6"
/**
...
import { minBy as _function_minBy } from "jsr:@std/collections@1.0.6"
/** UNDOCUMENTED */
const minBy = _function_minBy as typeof _function_minBy
export { minBy }

import { minOf as _function_minOf } from "jsr:@std/collections@1.0.6"
/** UNDOCUMENTED */
const minOf = _function_minOf as typeof _function_minOf
export { minOf }

import { minWith as _function_minWith } from "jsr:@std/collections@1.0.6"
/**
...
import { omit as _function_omit } from "jsr:@std/collections@1.0.6"
/**
...
import { partition as _function_partition } from "jsr:@std/collections@1.0.6"
/** UNDOCUMENTED */
const partition = _function_partition as typeof _function_partition
export { partition }

import { partitionEntries as _function_partitionEntries } from "jsr:@std/collections@1.0.6"
/**
...
import { permutations as _function_permutations } from "jsr:@std/collections@1.0.6"
/**
...
import { pick as _function_pick } from "jsr:@std/collections@1.0.6"
/**
...
import { reduceGroups as _function_reduceGroups } from "jsr:@std/collections@1.0.6"
/**
...
import { runningReduce as _function_runningReduce } from "jsr:@std/collections@1.0.6"
/**
...
import { sample as _function_sample } from "jsr:@std/collections@1.0.6"
/**
...
import type { SlidingWindowsOptions as _interface_SlidingWindowsOptions } from "jsr:@std/collections@1.0.6"
/**
...
import { slidingWindows as _function_slidingWindows } from "jsr:@std/collections@1.0.6"
/**
...
import type { Order as _typeAlias_Order } from "jsr:@std/collections@1.0.6"
/**
...
import type { SortByOptions as _typeAlias_SortByOptions } from "jsr:@std/collections@1.0.6"
/**
...
import { sortBy as _function_sortBy } from "jsr:@std/collections@1.0.6"
/** UNDOCUMENTED */
const sortBy = _function_sortBy as typeof _function_sortBy
export { sortBy }

import { sumOf as _function_sumOf } from "jsr:@std/collections@1.0.6"
/**
...
import { takeLastWhile as _function_takeLastWhile } from "jsr:@std/collections@1.0.6"
/**
...
import { takeWhile as _function_takeWhile } from "jsr:@std/collections@1.0.6"
/**
...
import { union as _function_union } from "jsr:@std/collections@1.0.6"
/**
...
import { unzip as _function_unzip } from "jsr:@std/collections@1.0.6"
/**
...
import { withoutAll as _function_withoutAll } from "jsr:@std/collections@1.0.6"
/**
...
import { zip as _function_zip } from "jsr:@std/collections@1.0.6"
/**
