import type { ConsoleHandlerOptions as _interface_ConsoleHandlerOptions } from "jsr:@std/log@0.224.7/console-handler"
/** UNDOCUMENTED */
interface ConsoleHandlerOptions extends _interface_ConsoleHandlerOptions {}
export type { ConsoleHandlerOptions }

import { ConsoleHandler as _class_ConsoleHandler } from "jsr:@std/log@0.224.7/console-handler"
/**
