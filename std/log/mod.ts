 ...
 * @module
 */
import type { FormatterFunction as _typeAlias_FormatterFunction } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
type FormatterFunction = _typeAlias_FormatterFunction
export type { FormatterFunction }

import type { BaseHandlerOptions as _interface_BaseHandlerOptions } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
interface BaseHandlerOptions extends _interface_BaseHandlerOptions {}
export type { BaseHandlerOptions }

import { BaseHandler as _class_BaseHandler } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
class BaseHandler extends _class_BaseHandler {}
export { BaseHandler }

import type { ConsoleHandlerOptions as _interface_ConsoleHandlerOptions } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
interface ConsoleHandlerOptions extends _interface_ConsoleHandlerOptions {}
export type { ConsoleHandlerOptions }

import { ConsoleHandler as _class_ConsoleHandler } from "jsr:@std/log@0.224.5"
/**
...
import type { LogMode as _typeAlias_LogMode } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
type LogMode = _typeAlias_LogMode
export type { LogMode }

import type { FileHandlerOptions as _interface_FileHandlerOptions } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
interface FileHandlerOptions extends _interface_FileHandlerOptions {}
export type { FileHandlerOptions }

import { FileHandler as _class_FileHandler } from "jsr:@std/log@0.224.5"
/**
...
import { RotatingFileHandler as _class_RotatingFileHandler } from "jsr:@std/log@0.224.5"
/**
...
import { LogLevels as _variable_LogLevels } from "jsr:@std/log@0.224.5"
/**
...
import type { LevelName as _typeAlias_LevelName } from "jsr:@std/log@0.224.5"
/**
...
import { LogLevelNames as _variable_LogLevelNames } from "jsr:@std/log@0.224.5"
/**
...
import type { LogRecordOptions as _interface_LogRecordOptions } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
interface LogRecordOptions extends _interface_LogRecordOptions {}
export type { LogRecordOptions }

import { LoggerConfig as _class_LoggerConfig } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
class LoggerConfig extends _class_LoggerConfig {}
export { LoggerConfig }

import type { LogConfig as _interface_LogConfig } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
interface LogConfig extends _interface_LogConfig {}
export type { LogConfig }

import { LogRecord as _class_LogRecord } from "jsr:@std/log@0.224.5"
/**
...
import type { LoggerOptions as _interface_LoggerOptions } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
interface LoggerOptions extends _interface_LoggerOptions {}
export type { LoggerOptions }

import { Logger as _class_Logger } from "jsr:@std/log@0.224.5"
/** UNDOCUMENTED */
