 ...
 * @module
 */
import type { FormatterFunction as _typeAlias_FormatterFunction } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
type FormatterFunction = _typeAlias_FormatterFunction
export type { FormatterFunction }

import type { BaseHandlerOptions as _interface_BaseHandlerOptions } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
interface BaseHandlerOptions extends _interface_BaseHandlerOptions {}
export type { BaseHandlerOptions }

import { BaseHandler as _class_BaseHandler } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
abstract class BaseHandler extends _class_BaseHandler {}
export { BaseHandler }

import type { ConsoleHandlerOptions as _interface_ConsoleHandlerOptions } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
interface ConsoleHandlerOptions extends _interface_ConsoleHandlerOptions {}
export type { ConsoleHandlerOptions }

import { ConsoleHandler as _class_ConsoleHandler } from "jsr:@std/log@0.224.8"
/**
...
import type { LogMode as _typeAlias_LogMode } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
type LogMode = _typeAlias_LogMode
export type { LogMode }

import type { FileHandlerOptions as _interface_FileHandlerOptions } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
interface FileHandlerOptions extends _interface_FileHandlerOptions {}
export type { FileHandlerOptions }

import { FileHandler as _class_FileHandler } from "jsr:@std/log@0.224.8"
/**
...
import { RotatingFileHandler as _class_RotatingFileHandler } from "jsr:@std/log@0.224.8"
/**
...
import { LogLevels as _variable_LogLevels } from "jsr:@std/log@0.224.8"
/**
...
import type { LogLevel as _typeAlias_LogLevel } from "jsr:@std/log@0.224.8"
/**
...
import type { LevelName as _typeAlias_LevelName } from "jsr:@std/log@0.224.8"
/**
...
import { LogLevelNames as _variable_LogLevelNames } from "jsr:@std/log@0.224.8"
/**
...
import { getLevelByName as _function_getLevelByName } from "jsr:@std/log@0.224.8"
/**
...
import { getLevelName as _function_getLevelName } from "jsr:@std/log@0.224.8"
/**
...
import type { GenericFunction as _typeAlias_GenericFunction } from "jsr:@std/log@0.224.8"
/**
...
import type { LogRecordOptions as _interface_LogRecordOptions } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
interface LogRecordOptions extends _interface_LogRecordOptions {}
export type { LogRecordOptions }

import { LoggerConfig as _class_LoggerConfig } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
class LoggerConfig extends _class_LoggerConfig {}
export { LoggerConfig }

import type { LogConfig as _interface_LogConfig } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
interface LogConfig extends _interface_LogConfig {}
export type { LogConfig }

import { LogRecord as _class_LogRecord } from "jsr:@std/log@0.224.8"
/**
...
import type { LoggerOptions as _interface_LoggerOptions } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
interface LoggerOptions extends _interface_LoggerOptions {}
export type { LoggerOptions }

import { Logger as _class_Logger } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
class Logger extends _class_Logger {}
export { Logger }

import { jsonFormatter as _function_jsonFormatter } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
const jsonFormatter = _function_jsonFormatter as typeof _function_jsonFormatter
export { jsonFormatter }

import { formatters as _variable_formatters } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
const formatters = _variable_formatters as typeof _variable_formatters
export { formatters }

import { critical as _function_critical } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
const critical = _function_critical as typeof _function_critical
export { critical }

import { debug as _function_debug } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
const debug = _function_debug as typeof _function_debug
export { debug }

import { error as _function_error } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
const error = _function_error as typeof _function_error
export { error }

import { getLogger as _function_getLogger } from "jsr:@std/log@0.224.8"
/**
...
import { info as _function_info } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
const info = _function_info as typeof _function_info
export { info }

import { setup as _function_setup } from "jsr:@std/log@0.224.8"
/**
 * Setup logger config.
 */
...
import { warn as _function_warn } from "jsr:@std/log@0.224.8"
/** UNDOCUMENTED */
