import type { LogMode as _typeAlias_LogMode } from "jsr:@std/log@0.224.8/file-handler"
/** UNDOCUMENTED */
type LogMode = _typeAlias_LogMode
export type { LogMode }

import type { FileHandlerOptions as _interface_FileHandlerOptions } from "jsr:@std/log@0.224.8/file-handler"
/** UNDOCUMENTED */
interface FileHandlerOptions extends _interface_FileHandlerOptions {}
export type { FileHandlerOptions }

import { FileHandler as _class_FileHandler } from "jsr:@std/log@0.224.8/file-handler"
/**
