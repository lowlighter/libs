import { LogLevels as _variable_LogLevels } from "jsr:@std/log@0.224.6/levels"
/**
...
import type { LogLevel as _typeAlias_LogLevel } from "jsr:@std/log@0.224.6/levels"
/**
...
import type { LevelName as _typeAlias_LevelName } from "jsr:@std/log@0.224.6/levels"
/**
...
import { LogLevelNames as _variable_LogLevelNames } from "jsr:@std/log@0.224.6/levels"
/**
...
import { getLevelByName as _function_getLevelByName } from "jsr:@std/log@0.224.6/levels"
/**
...
import { getLevelName as _function_getLevelName } from "jsr:@std/log@0.224.6/levels"
/**
