...
Deno.test("`hash()` returns digest as hexadecimal string", async () => {
...
Deno.test("`exportKey()` returns an exported `CryptoKey` as hexadecimal string", async () => {
...
Deno.test("`importKey()` returns an exported `CryptoKey` as hexadecimal string", async () => {
...
Deno.test("`encrypt()` encrypts data with specified key and returns a hash of specified length", async () => {
...
Deno.test("`encrypt()` returns a different hash value each time for same key", async () => {
  const key = "e8bf6e323c23036402989c3e89fe8e6219c18edbfde74a461b5f27d806e51f47"
  await expect(encrypt("🍱 bento", { key })).not.resolves.toBe(await encrypt("🍱 bento", { key }))
})

Deno.test("`decrypt()` returns data encrypted with specified key", async () => {
  const key = "e8bf6e323c23036402989c3e89fe8e6219c18edbfde74a461b5f27d806e51f47"
...
Deno.test("`decrypt()` supports long messages with length constraint disabled", async () => {
  const key = "e8bf6e323c23036402989c3e89fe8e6219c18edbfde74a461b5f27d806e51f47"
  await expect(decrypt(await encrypt("lorem ipsum".repeat(1000), { key, length: 0 }), { key })).resolves.toBe("lorem ipsum".repeat(1000))
})

Deno.test("`decrypt()` throws when message is larger than constrained length", async () => {
  const key = "e8bf6e323c23036402989c3e89fe8e6219c18edbfde74a461b5f27d806e51f47"
...
Deno.test("`decrypt()` throws when decrypted value mismatches registered hash", async () => {
  let message = "🍱 bento"
  const key = await importKey("e8bf6e323c23036402989c3e89fe8e6219c18edbfde74a461b5f27d806e51f47")
